...
install_opencv () {
  ...
  # if [[ $model == *"Jetson Nano"* ]]; then
    ...
    #sudo apt-get install -y python-dev python-numpy kairin - this line causes to hang on agx orin.
    ...
    sudo apt-get install -y libtbb2 libgtk-3-dev libxine2-dev #kairin - removed this from this line "v4l2ucp" since this requires unsupported qt4 <<qt5 << not supported.
  # fi
